...
private:
	...
	UFUNCTION()
	void OnAmmoCounterChanged(UMaterialInstanceDynamic* AmmoCounterDynMatInst, int32 RoundsCurrent, int32 RoundMax);
	
	UFUNCTION()
	void OnRoundFired(int32 RoundsCurrent, int32 RoundMax, int32 RoundsInReserve);
